...
[[https://github.com/Likhon-baRoy/.emacs.d][https://img.shields.io/github/repo-size/quickgrid/Code-Lab]]
...
[[https://github.com/torvalds/linux.git | perl -ne 'print $1 if m!([^/]+/[^/]+?)(?:\.git)?$!' | xargs -I{} curl -s -k https://api.github.com/repos/'{}' | grep size][]]
