...
Customization began with *single-file* =~/.emacs= with few settings and some random *snippets*. Didn't took long to become a monster. It loved to *cherry-pick* 🍒 packages literally form anywhere, I was like why don't you *apt-get*.
