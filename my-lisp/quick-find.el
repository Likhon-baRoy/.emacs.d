...
(quick-find "C-c C-x C-w" "~/wrx")
(quick-find "C-c C-x C-o" "~/wrx/org")
(quick-find "C-c C-i"     user-init-file)
;; (quick-find "C-c C-x C-k" user-keys-file)
(quick-find "C-c C-x C-q" "my-lisp/quick-find.el" user-emacs-directory)
(quick-find "C-c C-x C-y" "etc/yasnippet/snippets" user-emacs-directory)
